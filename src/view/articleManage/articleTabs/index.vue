<template>
  <el-form :inline="true" :model="formInline" class="demo-form-inline">
    <el-form-item label="文章标签名称">
    <el-input v-model="formInline.tabName" placeholder="请输入文章标签名称"></el-input>
  </el-form-item>
  <el-form-item label="文章标签id">
    <el-input v-model="formInline.id" placeholder="请输入文章标签id"></el-input>
  </el-form-item>
  <el-form-item>
...
<el-table
  ...
  >
    ...
    <el-table-column property="tabName" label="文章标签名称" width="120" />
  ...
  <el-form :model="dialogForm">
    <el-form-item label="分类名称" :label-width="formLabelWidth">
      <el-input v-model="dialogForm.tabName" autocomplete="off"></el-input>
    </el-form-item>
  </el-form>
  <template #footer>
