<template>
  <el-form :inline="true" :model="formInline" class="demo-form-inline">
    ...
    <el-input v-model="formInline.friendName" placeholder="请输入友链名称"></el-input>
  </el-form-item>
  <el-form-item label="友链id">
    <el-input v-model="formInline.id" placeholder="请输入友链id"></el-input>
  </el-form-item>
  <el-form-item label="友链地址">
    <el-input v-model="formInline.url" placeholder="请输入友链地址"></el-input>
  </el-form-item>
  <el-form-item label="友链时间">
    <el-input v-model="formInline.date" placeholder="请输入友链时间"></el-input>
  </el-form-item>
  <el-form-item>
...
<el-table
  ...
  <el-form :model="dialogForm">
    <el-form-item label="友链名称" :label-width="formLabelWidth">
      <el-input v-model="dialogForm.friendName" autocomplete="off"></el-input>
    </el-form-item>
    ...
    <el-form-item label="友链介绍" :label-width="formLabelWidth">
      <el-input v-model="dialogForm.intro" autocomplete="off"></el-input>
    </el-form-item>
  </el-form>
  <template #footer>
